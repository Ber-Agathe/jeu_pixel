...
def update():
    ...
    global vaisseau_x, vaisseau_y, tirs_liste, ennemis_liste, vies, explosions_liste, score
...
def draw():
    ...
    if vies > 0:
        ...
        # tirs
        for tir in tirs_liste:
            pyxel.blt(tir[0]-4, tir[1], 0, 8, 8, 8, 8)
        ...
        pyxel.text(80,5, 'SCORE:'+ str(score), 5)
